...
Pod::Spec.new do |s|
  s.name             = 'DDPublic'
  s.version          = '0.1.0'
  s.summary          = 'A short description of DDPublic.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/DuanChangHe/DDPublic'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'DuanChangHe' => 'duanchanghe@gmail.com' }
  s.source           = { :git => 'https://github.com/DuanChangHe/DDPublic.git', :tag => s.version.to_s }
